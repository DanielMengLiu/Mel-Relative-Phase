...
function [mel_freq] = linear2mel_sin(linear_freq)
...
%linear2mel 
%if linear_freq(i)>=0 & linear_freq(i)<=1000
%  mel_freq(i) =  1136/1000*linear_freq(i);
%elseif linear_freq(i)>1000 & linear_freq(i)<=2000
% mel_freq(i) = 189/1000*linear_freq(i)+947; 
%elseif linear_freq(i)>2000 & linear_freq(i)<=3000
%  mel_freq(i) = 379/500*linear_freq(i)-191; 
%elseif linear_freq(i)>3000 & linear_freq(i)<=6000
%  mel_freq(i) = 63/1000*linear_freq(i)+1894;  
%elseif linear_freq(i)>6000 & linear_freq(i)<=8000
%  mel_freq(i) = 71/250*linear_freq(i)+568;  
%end
